...
class CategoryStoreProduct extends StatefulWidget {
  ...
  @override
  State<CategoryStoreProduct> createState() => _CategoryStoreProductState();
}

class _CategoryStoreProductState extends State<CategoryStoreProduct> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: FutureBuilder(
            future: shopController.getShop(id: widget.shop_id),
            builder:
              ...
              if (snapshot.data!.body['status'] == 'fail') {
                return Text(snapshot.data!.body['Not found']);
              }
              Map shop = snapshot.data!.body['shop'];

              productController.getProductsByFilter(
                map: {
                  "shop_id": widget.shop_id,
                  "categories": widget.category['_id'],
                },
              );
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              "${widget.category["name"]}'s in ${shop["store_name"]}",
                              style: const TextStyle(
                                fontSize: 20,
                              ),
                            ),
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: shopController.filterList.length,
                                ...
                                return Obx(
                                  () => InkWell(
                                    onTap: () {
                                      ...
                                      productController.vegType = "";

                                      shopController.filter.value = index;
                                      if (index == 1 ||
                                          index == 2 ||
                                          index == 3) {
                                        productController.vegType =
                                            shopController.filterList[index];
                                        productController.price = "";
                            ...
                            child: Obx(
                              () => productController.isLoading.value
                                  ...
                                  : productController.products.isEmpty
                                      ? Center(
                                          child: Text(
                                              "No product found in ${widget.category["name"]}'s"),
                                        )
                                      : ListView.builder(
                                          shrinkWrap: true,
                                          physics: ScrollPhysics(),
